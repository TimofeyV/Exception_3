...
public class Month {
    ...
    public static final Month FEBRUARY_SHORT = new Month(2,28);
    public static final Month FEBRUARY_LONG = new Month(2,29);
    ...
    public static final Month[] array = {
            JANUARY,FEBRUARY_SHORT,MARCH,
            APRIL,MAY,JUNE,
            JULY, AUGUST,SEPTEMBER,
            OCTOBER,NOVEMBER,DECEMBER};
    public static final Month[] arrayWithOneMoreDay = {
            JANUARY,FEBRUARY_LONG,MARCH,
            APRIL,MAY,JUNE,
            JULY, AUGUST,SEPTEMBER,
            OCTOBER,NOVEMBER,DECEMBER};
